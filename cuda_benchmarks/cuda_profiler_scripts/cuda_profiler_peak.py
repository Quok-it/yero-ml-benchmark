...
# The use of fp8 is available for this script.
# This specific python scrypt is named cuda_profiler_peak for the above reason, as a peak level for a NVIDIA GPU to be at.
...
#
# '''
# This function excludes CPU operations made from the profiler trace file as to only contain GPU operations.
# It also adds any additional information not given by the original profiler trace file such as power draw
# and information about the benchmark.
# In addition, this reduces the profiler trace file size considerably.
# '''
...
# '''
# def cuda_profiler_peak(queue, stop_event, model, device, inputs, targets, criterion, optimizer,
