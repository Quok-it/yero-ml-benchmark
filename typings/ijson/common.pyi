...
@utils.coroutine
def parse_basecoro(target): # -> Generator[None, Any, NoReturn]:
    '''
...
@utils.coroutine
def items_basecoro(target, prefix, map_type=...): # -> Generator[None, Any, NoReturn]:
    '''
...
@utils.coroutine
def kvitems_basecoro(target, prefix, map_type=...): # -> Generator[None, Any, NoReturn]:
    '''
...
def integer_or_decimal(str_value): # -> int | Decimal:
    '''
...
def integer_or_float(str_value): # -> int | float:
    '''
...
def number(str_value): # -> int | Decimal:
    ...

def file_source(f, buf_size=...): # -> Generator[Any, Any, None]:
    '''A generator that yields data from a file-like object'''
    ...

def is_awaitablefunction(func): # -> bool:
    """True if `func` is an awaitable function"""
    ...

def is_async_file(f): # -> bool:
...
def parse(events): # -> Generator[Any, Any, None]:
    """Like ijson.parse, but takes events generated via ijson.basic_parse instead
    of a file"""
    ...

def kvitems(events, prefix, map_type=...): # -> Generator[Any, Any, None]:
    """Like ijson.kvitems, but takes events generated via ijson.parse instead of
    a file"""
    ...

def items(events, prefix, map_type=...): # -> Generator[Any, Any, None]:
